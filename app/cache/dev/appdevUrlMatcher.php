...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Mobile\\FrontendBundle\\Controller\\DefaultController::indexAction',  '_route' => 'homepage',);
        }

        // gallerypage
        if ($pathinfo === '/gallery') {
            return array (  '_controller' => 'Mobile\\FrontendBundle\\Controller\\GalleryController::indexAction',  '_route' => 'gallerypage',);
        }

        // contactspage
        if ($pathinfo === '/contacts') {
            return array (  '_controller' => 'Mobile\\FrontendBundle\\Controller\\ContactController::indexAction',  '_route' => 'contactspage',);
        }
